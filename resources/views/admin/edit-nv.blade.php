  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="{{route('edit-nhap-vao')}}">
          ...
          <fieldset class="form-group">
            <div class="row">
              ...
              <legend class="col-form-label col-sm-12 pt-0" style="color: green">Tổng tiền cần thành toán:  <b id="edit-thanh-tien"></b></legend>
